...
public class PmMD5 implements PmHashBuilder {
	...
	public static void main(String args[]) {
        ...
        // Get the hash for use in the password
		String hash;
		PmMD5 hb = new PmMD5();
		hash = hb.getHash("abc","abc");
        String encoding = new String();

        // Get the encoding character set
        // Get the trim
        boolean trim = true;

        // Modify the hash based on params
		PmHashUtils util = new PmHashUtils();
		System.out.println(util.rstr2any(hash,encoding,trim));
